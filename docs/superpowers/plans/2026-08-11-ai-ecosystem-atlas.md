...
**Tech Stack:** Next.js 16.3.0, React 19.2.8, TypeScript 7.0.2, Tailwind CSS 4.3.3, Zod 4.4.3, Lucide React 1.31.0, Vitest 4.1.10, Testing Library 16.3.2, jsdom 30.0.1, Playwright 1.62.1, npm.
